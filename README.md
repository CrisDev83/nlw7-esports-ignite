...
## API
Pré-requisitos mínimos: node v16.15.0  
Ligar o Servidor

```zsh
# clonar repositório
git clone https://github.com/CrisDev83/projetoEsports.git
...
```
## Aplicação MOBILE
Pré-requisitos: Expo GO instalado no celular
```zsh
...
# executar o projeto
npx expo start
abrir o expo go no celular
apontar o scan pra o QRcode na tela
```
